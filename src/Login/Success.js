...
class Login extends Component {
	...
	return (
		<>
			...
			<div className="container background  mx-auto lg:px-4 py-4 min-h-screen flex flex-col md:items-center md:justify-center">

			 
			<div className={`min-w-full packs1 md:min-w-0   rounded-xl shadow-xl   transition-all  transition shadow-md  focus:shadow-2xl w-1/2`}>
			
              <div className="px-4 py-8 text-center">
              		<Loading className="w-24 h-24" active />
                </div>
               	 <div className="text-center ">
                    <div className="text-3xl font-medium  mheadng">
					...
					<div className="flex flex-col p-4">
						<div className="font-medium button rounded-lg text-lg px-4 py-4   mt-4     inline-block" >
							Nearly Done...
						</div>
					</div>
                    </div>
