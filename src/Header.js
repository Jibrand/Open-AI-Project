...
import Logo1 from './user-3105265.png'
import Logo12 from "./12Logo.png"
...
class SidebarCompontent extends Component {
	...
	render() {
		return (
			...
			// 								 activeClassName="    toolphle text-gray-800 transition"
			// 								 className="text-lg flex py-3 px-6 lg:py-4 lg:px-8 cursor-pointer h  toolphle rounded-t-md font-medium transition  ">


			// 									 <img  src={Logo12}  className="logo12"  height='60px' width='1000px'  />
			// 									 <div className="hidden tool lg:block"> </div>
			// 									</NavLink>

			// 								{/* <div className="relative usericons   usericon flex flex-1 ">
			...
			// 										id="q"
			// 										name="q" 
			// 										className="py-4 pl-4 md:pl-14 text-xl usericon input1 focus:outline-none focus:bg-white focus:text-red  transition flex flex-1 w-full" placeholder="Search...  [Shortcut: Ctrl + K]" autoComplete="off" 
			...
			// 								 className={`text-lg   py-3  xl:py-4   cursor-pointer  iconuser rounded-t-md font-medium transition   `}>   <img  src={Logo1}  className="logo1" height='60px' width='40px'  /> 
